...
<article class="home_featured">
    ...
    <div class="home_featured_app">
        <img src="/themes/cafecontrol/__template/assets/images/home-app.jpg" alt="CafeControl" title="CafeControl"/>
    </div>
</article>
    ...
    <section class="container content">
        ...
        <div class="home_features_content">
            <article class="radius">
                <header>
                    <img alt="Contas a receber" title="Contas a receber" src="/themes/cafecontrol/__template/assets/images/home_receive.jpg"/>
            ...
            <article class="radius">
                <header>
                    <img alt="Contas a pagar" title="Contas a pagar" src="/themes/cafecontrol/__template/assets/images/home_pay.jpg"/>
            ...
            <article class="radius">
                <header>
                    <img alt="Controle e relatórios" title="Controle e relatórios" src="/themes/cafecontrol/__template/assets/images/home_control.jpg"/>
