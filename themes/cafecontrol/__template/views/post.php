<article class="post_page">
    <header class="post_page_header">
        <div class="post_page_hero">
            ...
            <img class="post_page_cover" alt="" title="" src="../assets/images/home-featured.jpg"/>
            <div class="post_page_meta">
                <div class="author">
                    <div><img src="../assets/images/avatar.jpg"/></div>
    ...
    <div class="post_page_content">
        <div class="htmlchars">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci doloribus quibusdam quis repellendus,
                similique totam.</p>

            <ul class="generic-list">
                <li class="item">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, asperiores.</li>
                <li class="item">Ducimus, eos minus. Amet asperiores, facilis laborum pariatur sequi voluptatibus.</li>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consectetur quas temporibus veniam
                voluptas. Dicta facere id incidunt ipsum neque rerum veritatis voluptatibus! Corporis cum dignissimos,
            ...
            <p>Aliquid architecto aspernatur assumenda, commodi consequuntur earum eum facilis inventore non obcaecati
                odit
                officia quam qui quidem quos reprehenderit sapiente vitae. Consequuntur fugiat neque vel.</p>

            <img alt="" title="" src="../assets/images/home-featured.jpg"/>

            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, aliquam cupiditate labore natus
                nostrum
                soluta veniam? Amet, autem blanditiis consequuntur corporis culpa cumque cupiditate dolor earum eos esse
                explicabo, impedit laudantium nostrum omnis, optio pariatur porro qui recusandae reiciendis rem sapiente
                tenetur ut. Blanditiis doloremque ipsa quod sequi. Dolore, temporibus!</p>

            <p>Amet asperiores debitis impedit minus, nobis pariatur porro sunt suscipit vitae! Accusamus consequuntur
            ...
            <p>Consequatur dolores error est fugiat inventore ipsa magnam nemo nesciunt, nobis numquam obcaecati
                perferendis
                quisquam ratione rem reprehenderit sequi temporibus. Accusantium autem beatae dolore doloremque laborum
        ...
        <aside class="social_share">
            ...
            <div class="social_share_medias">
                <!--facebook-->
                <div class="fb-share-button" data-href="https://www.fsphp.com/post/"
                     data-layout="button_count" data-size="large" data-mobile-iframe="true">
                    <a target="_blank"
                       href="https://www.facebook.com/sharer/sharer.php?u=https://www.fsphp.com/post"
                ...
                <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-size="large"
                   data-text="Text" data-url="https://www.fsphp.com/post" data-via="username" data-hashtags="hashtag"
                   data-related="account" data-show-count="false">Tweet</a>
